...
namespace Moldovan_Paula_Lab4
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Facultate\master\anul 1\dezvoltarea de sisteme de big data\8 ian\recommendation-ratings-train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"movieId",inputColumnName:@"movieId",addKeyValueAnnotationsAsText:false)      
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(new MatrixFactorizationTrainer.Options(){LabelColumnName=@"rating",MatrixColumnIndexColumnName=@"userId",MatrixRowIndexColumnName=@"movieId",ApproximationRank=13,LearningRate=0.2731444231166303,NumberOfIterations=114,Quiet=true}))      
